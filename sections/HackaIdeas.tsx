          ...
          <div class="max-w-5xl mx-auto">
            ...
            >
              {ideas.map((idea) => {
                ...
                return (
                  <div class="flex items-start gap-3 md:gap-6 group bg-white/80 backdrop-blur-sm rounded-2xl p-6 md:p-8 border border-primary-dark/10 hover:shadow-lg transition-all duration-300">
                    <div
                      class={`w-12 md:w-16 h-12 md:h-16 rounded-xl ${style.accent} flex items-center justify-center flex-shrink-0`}
                    >
                      <span
                        class={`material-symbols-rounded text-2xl md:text-4xl ${style.icon}`}
                      >
                        {idea.icon}
                      </span>
                    </div>
                    <div class="min-w-0">
                      <h3 class="text-lg md:text-2xl font-medium text-primary-dark group-hover:text-primary transition-colors duration-300 mb-2 md:mb-3">
                        {idea.title}
                      </h3>
